...
VALUES (
    'strategyRules', 'Automation', 'Strategy Rules',
    'Configure Go strategy rule conditions that publish order requests from shared indicators.',
    'Go strategy rules', 'chart', '/dashboard/strategyRules',
...
-- +goose Down
DELETE FROM dashboard_pages WHERE resource_key = 'strategyRules';
